;var wheelfunc = {
	winfo : ['一等奖', '谢谢参与', '二等奖', '谢谢参与', '三等奖', '谢谢参与',],
  ...
  return {
    ...
    link : function($scope,elem,attr){
    	...
    	for(var i = 0; i < $scope.$storage.form.form_fields.length; i++){
            ...
            if(current.field_id == "1"){
            	wcolor = [current.field_bgcolor1,current.field_bgcolor2];
            	wfcolor = current.field_color;
            };
        };
